  ...
  return (
    <div>
      <div className="container ">
        <h1 className="bg-gradient-to-r from-secondary-700 to-secondary-900 bg-clip-text text-transparent pt-5 md:pt-14 text-4xl  md:text-6xl font-semibold">
      ...
      <div className="container">
        <div className="flex pt-14 items-center justify-between">
          ...
          <Link className='text-semibold md:text-xl text-secondary-400' href={'/blog/posts'}>View All</Link>
        </div>
