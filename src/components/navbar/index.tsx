    ...
    <>
      <nav className="sticky left-0 top-0 z-20 w-full   bg-primary-100  dark:bg-primary-950">
        <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
          ...
          >
            <ul className="mt-4 flex flex-col rounded-lg border border-primary-100 bg-primary-100 p-4 font-medium dark:border-primary-700 dark:bg-primary-950 md:mt-0 md:flex-row md:space-x-8 md:border-0 md:p-0 ">
                ...
                return (
                  <li>
                    <a
                      ...
                      } block rounded py-2 pl-3 pr-4 hover:text-great-blue-400 md:bg-transparent md:p-0  `}
                      aria-current="page"
                    >
                      {link.title}
                    </a>
